...
class AdsManager {
  ...
  async testAdElement() {
    return new Promise(resolve => {
      ...
      adElement.style.cssText = 'position: fixed; top: -9999px; left: -9999px; width: 728px; height: 90px; visibility: hidden; z-index: -9999;';
  ...
  showFallbackAds() {
    ...
    ['ad-above-iframe', 'ad-below-iframe', 'ad-sidebar'].forEach(id => {
